...
Every figure below is drawn from `data/processed/career_market_panel.csv`. How that table was built, and where its gaps are, is documented on the [Data Preparation](data_preparation.qmd) page. Coverage varies by field, so each chart states how many postings it is based on.
